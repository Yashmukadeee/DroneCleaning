...
export const ARTICLES_DATA: Article[] = [
  ...
  },
  {
    ...
    category: 'Technology',
    summary: 'Super-tall architectural structures generate violent down-draughts, venturi flow, and corner shedding vortices. This paper explores dynamic closed-loop thrust vectoring and adaptive PID gain scheduling to maintain 15mm standoff precision.',
    content: `
      <p class="lead text-xl text-slate-700 font-medium mb-6">
      ...
      <p class="mb-4 text-slate-600 leading-relaxed">
        By utilizing multi-axis vectorable coaxial thrusters and integrating live airflow pressure differential sensors (pitot-static arrays), the flight controller dynamically alters thrust orientation without requiring the central chassis to tilt towards the facade. This decouples spray trajectory from attitude stabilization, preserving optimal wash coverage even in 38-knot wind buffeting.
      </p>
    `,
    keyTakeaways: [
      'Decoupled thrust-vectoring prevents chassis tilt while counteracting 38-knot gust forces.',
      'Adaptive gain scheduling suppresses oscillations near architectural shear edges and sharp corners.',
      'Maintains consistent 1.20-meter fluid impingement geometry throughout extreme urban vortexes.',
      'Significantly widens operational weather flight windows from 12 knots to 35+ knots.'
    ],
  ...
  },
  {
    ...
    title: 'Case Study: 500MW Desert Photovoltaic Facility Soiling Mitigation & Yield Recovery',
    slug: 'utility-scale-pv-solar-farm-drone-washing-case-study',
    category: 'Case Studies',
    summary: 'A field validation of autonomous aerial soft-washing across a 500-megawatt desert solar installation, demonstrating a 14.8% power yield restoration, 90% water volume savings, and zero panel micro-abrasion.',
    content: `
      <p class="lead text-xl text-slate-700 font-medium mb-6">
        Desert-based utility-scale solar photovoltaic (PV) plants suffer from rapid airborne dust accumulation, cementation soiling, and bird soiling, which degrade power production capacity by 12% to 25% within weeks of dry weather.
      </p>

      <h3 class="text-2xl font-bold text-slate-900 mt-8 mb-4">The Failure of Tractor & Robotic Crawler Systems</h3>
      <p class="mb-4 text-slate-600 leading-relaxed">
        Ground-based tractor sprayers consume excessive water and damage delicate desert soil ecosystems, while rail-mounted crawler bots suffer frequent mechanical track jamming from sand ingress and can cause micro-cracks in crystalline silicon cells due to weight pressure.
      </p>

      <h3 class="text-2xl font-bold text-slate-900 mt-8 mb-4">Autonomous Drone Soft-Wash Deployment</h3>
      <p class="mb-4 text-slate-600 leading-relaxed">
        Utilizing autonomous swarm flight paths and high-speed pure-water atomization at 45-degree incidence angles, a fleet of 4 drones cleaned 120,000 solar modules per day with zero physical surface contact.
      </p>
        ...
        <table class="w-full text-left border-collapse bg-white rounded-xl overflow-hidden shadow-sm border border-slate-200">
          <thead>
            <tr class="bg-sky-600 text-white text-sm">
              ...
              <th class="p-3.5">Autonomous Drone System</th>
            </tr>
          </thead>
          <tbody class="text-sm divide-y divide-slate-200 text-slate-700">
            <tr>
            ...
            <tr>
              ...
              <td class="p-3.5 text-emerald-600 font-bold">+14.8% restored</td>
            </tr>
            <tr>
    ...
    `,
    keyTakeaways: [
      'Restored 14.8% electricity yield across 500MW solar array in 4 operational days.',
      '90% water conservation utilizing precision high-pressure deionized atomization nozzles.',
      'Contactless flight eliminates mechanical brush abrasion and silicon micro-cracking.',
